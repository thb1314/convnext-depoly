...
class GeluPlugin final : public nvinfer1::IPluginV2DynamicExt
{
public:
    GeluPlugin(const void* data, size_t length);

    // It doesn't make sense to make GeluPlugin without arguments, so we
...
public:
    ...
    ~GeluPluginCreator() override = default;
